...
<body>
    <h1>Add new Product</h1>
        <form:form action="processUpdateProductForm" modelAttribute="productDetailsModel" method="post">
            <div class="container mt-5">
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="id">Product ID: ${productDetailsModel.id}</label>
                        </div>
                        <div class="form-group">
